...
export const billingPlans: BillingPlan[] = [
  ...
  },
  {
    ...
    period: { en: "/month", bn: "/মাস" },
    features: [
      { en: "Everything in Pro", bn: "প্রো-তে যা কিছু আছে" },
      { en: "Advanced exam simulations", bn: "অ্যাডভান্সড পরীক্ষা সিমুলেশন" },
      { en: "1-on-1 doubt-clearing sessions", bn: "১-এ-১ সন্দেহ নিরসন সেশন" },
    ],
  },
];
